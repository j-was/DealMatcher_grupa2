    ...
    public static async Task SeedOffers(AppDbContext dbContext)
    {
        ...
        [
            ...
            new Offer(
                ...
                price: 89.99m,
                imageUrls: ["https://dealmatcherstorage.blob.core.windows.net/pictures/sukienka-wieczorowa.jpg"],
                sellerId: sellerIds[3],
            ...
            new Offer(
                ...
                price: 399.00m,
                imageUrls: ["https://dealmatcherstorage.blob.core.windows.net/pictures/garnitur.webp"],
                sellerId: sellerIds[5],
        ...
        [
            new Offer(
                ...
                price: 599.00m,
                imageUrls: ["https://dealmatcherstorage.blob.core.windows.net/pictures/OPONY-ZIMOWE-zestaw-4-szt.jpg"],
                sellerId: sellerIds[0],
