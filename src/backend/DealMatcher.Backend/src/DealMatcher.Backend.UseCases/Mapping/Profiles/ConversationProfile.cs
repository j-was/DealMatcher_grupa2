...
public sealed class ConversationProfile : Profile
{
    public ConversationProfile()
    {
        CreateMap<MessageEntity, MessageDTO>()
            ...
            .ForCtorParam(nameof(MessageDTO.Status), opt => opt.MapFrom(src => src.Status.Value.ToUpper()))
        ...
        CreateMap<ConversationEntity, ConversationDTO>()
            ...
            .ForCtorParam(nameof(ConversationDTO.Status), opt => opt.MapFrom(src => src.Status.Value.ToUpper()))
        ...
        CreateMap<ConversationEntity, ConversationDetailsDTO>()
            ...
            .ForCtorParam(nameof(ConversationDetailsDTO.Status), opt => opt.MapFrom(src => src.Status.Value.ToUpper()))
