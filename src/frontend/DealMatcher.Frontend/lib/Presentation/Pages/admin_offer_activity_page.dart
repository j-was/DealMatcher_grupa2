...
class AdminOfferActivityPage extends StatefulWidget {
  final int offerId;

  const AdminOfferActivityPage({super.key, required this.offerId});

  @override
  State<AdminOfferActivityPage> createState() => _AdminOfferActivityPageState();
}

class _AdminOfferActivityPageState extends State<AdminOfferActivityPage> {
  DateTime? _from;
  DateTime? _to;
  ...
  Future<List<ActivityRecord>> _loadActivities() {
    return AdminService().getOfferActivity(
      widget.offerId,
      from: _from,
      to: _to,
    );
    ...
    return FutureBuilder<List<ActivityRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        return AdminActivitySection(
          records: records,
          emptyMessage: 'Brak aktywności dla tej oferty.',
        );
      },
    );
  }
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Aktywność oferty #${widget.offerId}',
