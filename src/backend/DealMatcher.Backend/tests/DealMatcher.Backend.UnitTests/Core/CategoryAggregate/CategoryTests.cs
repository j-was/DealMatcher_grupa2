...
public class CategoryTests
{
    ...
    {
        var category = new Category("Electronics", "Electronic devices", TestProperties);
    ...
    public void Constructor_Should_Throw_When_Name_Is_Invalid(string invalidName)
    {
        Should.Throw<ArgumentException>(() =>
            new Category(invalidName!, "Description", TestProperties));
    }
    ...
    {
        var category = new Category("Electronics", "Description", null);
    ...
    {
        var category = new Category("Electronics", "", TestProperties);
    ...
    {
        var category = new Category("  Electronics  ", "  Description  ", TestProperties);
    ...
    {
        var category = new Category("Old Name", "Old Description", TestProperties);
    ...
    {
        var category = new Category("Valid Name", "Description", TestProperties);
    ...
    {
        var category = new Category("Valid Name", "Old Description", TestProperties);
