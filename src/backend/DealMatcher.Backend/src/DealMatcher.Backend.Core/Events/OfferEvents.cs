...
public sealed class OfferCreatedEvent(int userId, int offerId, string title, string description, decimal price, int availability) : DomainEventBase
{
...
public sealed class OfferUpdatedEvent(int userId, int offerId, string title, string description, decimal price, int availability) : DomainEventBase
{
    public int UserId { get; init; } = userId;
    public int OfferId { get; init; } = offerId;
    public string Title { get; init; } = title;
...
public sealed class OfferPurchasedEvent(int userId, int offerId, int quantity, int remaining, decimal price) : DomainEventBase
{
    public int UserId { get; init; } = userId;
    public int OfferId { get; init; } = offerId;
