...
/// <inheritdoc />
public partial class BasicAggreagtes : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_CategoryProperties", x => new { x.CategoryId, x.Id });
                table.ForeignKey(
                    name: "FK_CategoryProperties_Categorys_CategoryId",
